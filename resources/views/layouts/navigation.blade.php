...
<aside id="sidebar"
    ...
    <nav class="p-4 space-y-2 text-sm">
        ...
        <a href="{{ route('activity-log.index') }}"
            class="flex items-center gap-2 p-3 rounded-lg transition-colors {{ active('activity-log.*') }}">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 text-current opacity-70" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
